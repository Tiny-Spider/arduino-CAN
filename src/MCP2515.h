...
#define MCP2515_DEFAULT_CS_PIN    PIN_CAN_CS
#define MCP2515_DEFAULT_INT_PIN   PIN_CAN_INTERRUPT
#elif defined(ARDUINO_ARCH_SAMD) && defined(PIN_SPI_MISO) && defined(PIN_SPI_MOSI) && defined(PIN_SPI_SCK) && (PIN_SPI_MISO == 10) && (PIN_SPI_MOSI == 8) && (PIN_SPI_SCK == 9)
